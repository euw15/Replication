 ...
 * @author Melvin
 */
public class RPCreateHistoricalMSQL {

    private final RPConnectionInterface connection;

    public RPCreateHistoricalMSQL(RPConnectionInterface connection) {
    ...
    public void createHistorical() {
        try {
            ...
            String path = "/com/replication/admin/Scripts/InsertHistoricalMSQL.sql";
